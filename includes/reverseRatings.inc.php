...
<!--For use when the answer always is not positive.-->
<div class="row">
	<div class="col-sm-offset-1 text-center col-xs-6 col-sm-2">
		<label class="radio-inline">
			...
			<img src="img/always.png" alt="NEVER" class="img-responsive" onclick="myFunction()">
		</label>
	...
	<div class="text-center col-xs-6 col-sm-2">
		...
		<img src="img/mostly.png" alt="RARELY"  class="img-responsive" onclick="myFunction()">
		</label>
	</div><!-- /text-center col-xs-6 col-sm-2-->
	<div class="text-center col-xs-6 col-sm-2">
		<label class="radio-inline">
		...
		<img src="img/sometimes.png" alt="SOMETIMES</span> " class="img-responsive" onclick="myFunction()">
		</label>
	</div><!-- /text-center col-xs-6 col-sm-2-->
	<div class="text-center col-xs-6 col-sm-2">
		<label class="radio-inline">
		...
		<img src="img/rarely.png" alt="OFTEN" class="img-responsive" onclick="myFunction()">
		</label>
	</div><!-- /text-center col-xs-6 col-sm-2-->
	<div class="text-center col-xs-6 col-sm-2">
		<label class="radio-inline">
		...
		<img src="img/never.png" alt="ALWAYS" class="img-responsive" onclick="myFunction()">
		</label>
	</div><!-- /text-center col-xs-6 col-sm-2-->
</div><!-- /row -->
